...
이 름|업 무|세부 사항
--|--|--
박영준|Deep Learning Model 설계, 구현| attention mechanism과 seq2seq를 통한 모델 설계 및 서버 구축
문명기|Deep Learning Model 설계, 구현|attention mechanism과 seq2seq를 통한 모델 설계 및 서버 구축
김세진|비정형 클러스터링, 앱 개발| k-means 클러스터링에 대한 이해와 구현 및 앱 개발을 위한 플러터 학습 및 구현
이호찬|앱 개발, 추천 알고리즘| 앱 개발을 위한 플러터 학습 및 구현과 추천 알고리즘을 위한 Collaborative Filtering 학습 및 최적의 알고리즘 선별
조동철|Deep Learning Model 설계, 구현, 전처리|k-means 클러스터링에 대한 이해와 구현 및 추천 알고리즘을 위한 Collaborative Filtering 학습 및 최적의 알고리즘 선별
</br>
